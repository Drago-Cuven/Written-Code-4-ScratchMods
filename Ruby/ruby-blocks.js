...
(async function (Scratch) {
    ...
    const {DefaultRubyVM} = await import('https://cdn.jsdelivr.net/npm/@ruby/wasm-wasi@2.7.0/dist/browser/+esm');
          ...
          return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: 'reload ruby on flag press? [ROFP]',
                    arguments: {
                        ROFP: {
    ...
    async execute(args) {
        return await ruby.eval(args.CODE);
    }
