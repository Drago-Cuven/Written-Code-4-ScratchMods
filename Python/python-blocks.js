...
(async function (Scratch) {
    ...
    const menuIconURI = "data:image/svg+xml;base64,";
      ...
      const {PythonFactory} = await import('https://cdn.jsdelivr.net/npm/wasmoon/+esm');
      const factory = new PythonFactory();
      let Pythonon = false;
      let Python = await factory.createEngine();
      Pythonon = true;
      ...
      async function resetPython() {
        ...
        Python.global.close();
        Python = await factory.createEngine();
        for (var i = 0; i < threads.length; i++) {
      ...
      class extension {
        ...
        async getPythonVar(args) {
          const PythonVar = Python.global.get(args.VAR);
          return (typeof args.VAR === 'number' || PythonVar instanceof Error || PythonVar == null) ? "" : PythonVar;
      }
      ...
      _constructFakeUtil(realUtil) {
       ...
       getpfuncArgsnum(args, util) {
        ...
        initPythonCommands(util) {
          ...
          // Setting  pfunc
          Python.global.set('pfunc', (...args) => {
            let argsString = args;
            let pfuncthread = [];
            pfuncthread = util.startHats("Drago0znzwPython_linkedFunctionCallback");
            for (const thread of pfuncthread) thread[pfuncargs] = argsString;
            return pfuncthread;
          });
  
          // Setting up the target
          Python.global.set('sprite', {
          ...
          Python.global.set('MathUtil', this.MathUtil);
    
          // Category: motion
          Python.global.set('motion', {
          ...
          // Category: events
          Python.global.set('events', {
            broadcast: ref('events_broadcast'),
          });
          // Category: control
          Python.global.set('control', {
            wait: ref('control_wait'),
          });
          // Category: data
          Python.global.set('data', {
          ...
          Python.global.set('Cast', Cast);
    
          // Custom category: JS
          Python.global.set('JS', {
            JSON: {
              parse(...args) {
                // @ts-expect-error
        ...
        secret_injectFunction({ namespace, args, js }) {
          Python.global.set(Cast.toString(namespace), (new Function('Python', ...args.split(' '), js).bind(window, Python)))
        }
        ...
        async runPython({CODE}, util) {
          if (Pythonon == false) {
            ...
            return await Python.doString(Cast.toString(CODE));
          }
        }
      }
    /*
      runtime.on('PROJECT_START', () => resetPython ());
